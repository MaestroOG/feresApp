        ...
        <div>
            ...
            <div className='my-6'>
                {services?.map((service) => (
                    <Container 
                        key={service.ExpressServiceName}
                        className={`border border-[#EAEAEA] w-[398px] h-[78px] rounded-2xl mx-auto flex items-center justify-between my-5 cursor-pointer ${selectedOption === service.ExpressServiceName ? 'border-[#0AB247]' : ''}`}
                        onClick={() => handleOptionChange(service.ExpressServiceName)}
                    >
                        ...
                        <input 
                            type="radio" 
                            name="delivery" 
                            value={service.ExpressServiceName}
                            checked={selectedOption === service.ExpressServiceName}
                            onChange={() => handleOptionChange(service.ExpressServiceName)} 
