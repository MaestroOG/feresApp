...
const RecipientUpdatePhone = () => {
    ...
    return (
        <>
            ...
            <Container className={'py-5 w-full fixed left-0 bottom-0 bg-white'} onClick={() => navigate('/deliveryservice/deliverydetails/recipientdetails/updatephone/verifyphone')}>
...
export default RecipientUpdatePhone