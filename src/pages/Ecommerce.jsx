                    ...
                    <div className="my-5">
                        ...
                        <div className='flex items-center gap-2 overflow-auto no-scrollbar'>
                            {offers && offers?.offers.map(offer => (
                                offer?.list.map(li => (
                                    <div className="flex items-center gap-2 rounded-[13px]">
                                        <div className='first-of-type:pl-2 rounded-[13px]' key={li?.id} onClick={() => navigate(`/ecommerce/mart/${li?.category_id}`)}>
                                            <div className='w-36 h-44 rounded-[13px] bg-[#EFF7D7] p-2 px-3 relative'>
                                                <h3 className='text-[#2F2F3F]'>{li?.position?.position_title}</h3>
                                                <img src={li?.featured_image} alt="" className='rounded-[13px] absolute bottom-0 right-0 object-cover' width={"127px"} height={"179px"} />
                                                <img src={assets.ecommerce_card_shape} alt="" className='rounded-[13px] absolute bottom-0 left-0' />
