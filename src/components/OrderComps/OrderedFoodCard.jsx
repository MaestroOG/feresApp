...
const OrderedFoodCard = ({ title, desc, price, quantity }) => {
    ...
    return (
        <>
            <div className='mt-6 flex items-center gap-3 rounded-2xl px-6'>
                <img src={assets.item_placeholder} alt="" className='w-28 mb-auto py-[6px]' />
                <div className='pr-1'>
                    ...
                    <div className='flex items-center justify-between mt-2'>
                        ...
                        <div className='flex items-center justify-between border border-[#EEEEEE] rounded-full gap-5 px-2 py-1 w-[88px] h-[33px]'>
                            <img src={assets.minus_sign} alt="" className='invert w-[11px]' onClick={() => {
                                orderCount > 0 ? setOrderCount(quantity - 1) : null
                            }} />
