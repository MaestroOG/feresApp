    ...
    return (
        <div className='fixed bottom-0 w-full rounded-3xl bg-white py-4'>
            ...
            <div className='flex flex-col gap-4 mt-3 pb-3'>
                <button className='bg-[#0AB247] text-white w-[95%] mx-auto rounded-full py-[16px] text-lg font-medium'>Select feres keeper 90 min</button>
                <button className='text-[#0AB247] bg-[#F2FDF8] w-[95%] mx-auto rounded-full py-[16px] text-lg font-medium'>Stay with normal (30 min)</button>
            </div>
        </div>
    )
}
