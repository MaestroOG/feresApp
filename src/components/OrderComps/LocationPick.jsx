    ...
    return (
        <div className='px-4 rounded-[13px]'>
            ...
            <div className='w-full mt-4 flex flex-col gap-3 pb-5'>
                <input type="number" placeholder='Apt./office/floor/postal code' className='bg-[#F8F8F8] w-full py-[10px] px-[20px] rounded-[13px] placeholder:text-[#767578] outline-none transition-all ease-linear focus:bg-white focus:border focus:border-[#0AB247]' />
