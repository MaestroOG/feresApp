...
const RateRiderFb = () => {
    ...
    return (
        <div className='mt-5'>
            ...
            <p className='text-[#767578] text-center text-base font-normal mt-3 w-[70%] mx-auto'>How was the delivery of your order from KFC Eastlight</p>
            <div className='h-[135px] bg-[#F8F8F8] rounded-[13px] mt-4 focus-within:bg-white focus-within:border focus-within:border-[#0AB247] transition-all ease-linear'>
                <input type="text" placeholder='Write your feedback here' className='placeholder:text-[#767578] bg-transparent w-full rounded-[13px] py-[14px] px-4 border-none outline-none' />
            </div>
