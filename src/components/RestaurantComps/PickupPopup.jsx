...
const PickupPopup = () => {
    ...
    return (
        <div className={`fixed bottom-0 left-0 rounded-3xl z-50 bg-white w-full h-[20vh] py-4 border border-[#F7F7F7] ${visible ? 'hidden' : ''}`}>
            <div className='flex items-center justify-between px-3 w-[58%] ml-auto'>
