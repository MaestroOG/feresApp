...
const AddressForm = () => {
    return (
        <Container>
            <form>
                <input type="text" className='bg-[#F8F8F8] text-[#2F2F3F] rounded-[13px] w-full p-5 placeholder:text-[#767578] mb-5' placeholder='Building name' />
                ...
                <input type="text" className='bg-[#F8F8F8] text-[#2F2F3F] rounded-[13px] w-full p-5 placeholder:text-[#767578] mb-5' placeholder='Building name' value={"Elgin St. Celina, Delaware 10299"} />
