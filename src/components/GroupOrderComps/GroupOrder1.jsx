    ...
    return (
        <div className='h-screen w-full bg-[#06060626] fixed top-0 z-[100] left-0'>
            <Container className='fixed bottom-0 left-0 bg-white rounded-t-2xl min-h-[662px] w-full'>
                ...
                <div className='border border-[#EEEEEE] rounded-2xl px-5 py-6 flex items-center justify-between'>
                ...
                <div className='mt-6'>
                    <button className='w-full bg-[#0AB247] rounded-full p-4 text-white text-lg font-medium mb-5'>Invite people</button>
                    <button className='w-full bg-[#EBF9EE] rounded-full p-4 flex items-center justify-center gap-2'>
