    ...
    return (
        <div className='h-screen w-full bg-[#06060626] z-[100] fixed top-0 left-0'>
            <Container className={'fixed w-full bottom-0 left-0 rounded-t-2xl min-h-[588px] bg-white'}>
                <img src={assets.cancel_icon} alt="" className='py-4' onClick={onCancel} />
                ...
                <button onClick={() => navigate('/grouporder/review')} className='w-full bg-[#0AB247] rounded-full p-4 text-white text-lg font-medium mb-5'>Start ordering</button>
            </Container>
        </div>
    )
}
