        ...
        <div className='mt-20'>
            ...
            {payments?.map((item, index) => (
                <React.Fragment key={item?._id || index}>
                    <label htmlFor={`cash-${index}`} className='border border-[#EAEAEA] rounded-[16px] px-4 py-4 flex items-center justify-between mt-4'>
                        <div className='flex items-center gap-2'>
                            <img src={assets.wavy_money_bill} alt="" />
                            <p className='text-[#2F2F3F] text-lg'>Cash</p>
                        </div>
                    ...
                    <label htmlFor={`ebirr-${index}`} className='border border-[#EAEAEA] rounded-[16px] px-4 py-4 flex items-center justify-between mt-4'>
                        <div className='flex items-center gap-2'>
                            <img src={item?.image_url} alt="" width="40px" />
                            <p className='text-[#2F2F3F] text-lg'>{item?.name}</p>
                        </div>
