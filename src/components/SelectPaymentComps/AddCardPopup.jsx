...
const AddCardPopup = ({ onCancelClick }) => {
    return (
        <div className='fixed bottom-0 left-0 w-full z-30 pt-4 pb-5 bg-white rounded-tl-3xl rounded-tr-3xl shadow-md shadow-[#96969640]'>
            ...
            <div className='mt-4 flex flex-col items-center '>
                ...
                <button className='bg-[#0AB247] p-[16px] rounded-[30px] w-[92%] my-4 mx-auto text-white text-lg font-medium'>Select and delete card</button>
